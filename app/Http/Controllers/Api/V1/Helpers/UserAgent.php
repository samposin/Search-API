<?php namespace App\Http\Controllers\Api\V1\Helpers;
...
class UserAgent {
	...
	public static function getBrowser( $u_agent = null )
	{
		...
		$visitor_user_agent_info_arr=UserAgent::parse_user_agent($u_agent);

		if(isset($visitor_user_agent_info_arr['browser']))
			$browser=$visitor_user_agent_info_arr['browser'];
